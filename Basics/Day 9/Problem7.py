...
print("Total Distinct Unique Pairs (No Repetition):", pair_count // 16)
print("Total Valid Pairs (With Repetition):", pair_count // 32)
print("Total Valid Pairs (Order Matters):", pair_count // 64)
print("Total Valid Pairs (Order Matters, With Repetition):", pair_count // 128)